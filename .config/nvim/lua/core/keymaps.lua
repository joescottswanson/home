...
-- from OG vimrc
keymap.set("n", "K", "i<CR><Esc>g") -- split lines under the cursor
keymap.set("n", "<leader>td", ":put! =strftime('== %Y-%m-%d ==')<CR>") -- get a datestamp for vimwiki diary
keymap.set("n", "<leader>q", "gqip") -- reformat a paragraph
...
-- Yazi
keymap.set('n', '<leader>yf', '<cmd>Yazi<cr>') -- Open yazi at the current file
-- keymap.set('v', '<leader>yf', '<cmd>Yazi<cr>') -- Open yazi at the current file
keymap.set('n', '<leader>yd', '<cmd>Yazi cwd<cr>') -- Open yazi at the current working directory
-- keymap.set('v', '<leader>yd', '<cmd>Yazi cwd<cr>') -- Open yazi at the current working directory
keymap.set('n', '<leader>yr', '<cmd>Yazi cwd<cr>') -- Resume last yazi session
